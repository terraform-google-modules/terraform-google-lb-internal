...
insert_separator_regex = '(.*?\[\^\]\:\ \(autogen_docs_start\))(.*?)(\n\[\^\]\:\ \(autogen_docs_end\).*?$)'  # noqa: W605 E501
exclude_separator_regex = '(.*?)Copyright 20\d\d Google LLC.*?limitations under the License.(.*?)$'  # noqa: W605 E501
...
groups = re.match(exclude_separator_regex, replace_content, re.DOTALL).groups(0)  # noqa: E501
