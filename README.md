...
- [`google_compute_health_check.ssl`](https://www.terraform.io/docs/providers/google/r/compute_health_check.html): The SSL health check for the `instance_group` targets.
...
- [`google_compute_health_check.https`](https://www.terraform.io/docs/providers/google/r/compute_health_check.html): The HTTPS health check for the `instance_group` targets.
- [`google_compute_health_check.http2`](https://www.terraform.io/docs/providers/google/r/compute_health_check.html): The HTTP2 health check for the `instance_group` targets.
